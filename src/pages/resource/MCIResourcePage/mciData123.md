...
### What types of clinical testing are conducted on the specimens submitted for MCI?
 ...
 The Steve and Cindy Rasmussen Institute for Genomic Medicine (IGM) at Nationwide Children’s Hospital in Columbus, OH, will conduct:

 
- Enhanced paired tumor–normal exome sequencing (ES)
 - A targeted RNA Solid Tumor Fusion assay*
 - A DNA-based methylation array assay for CNS tumor classification
...
body:
  - Tumor + normal DNA
  - Enhanced ES
  - 'Germline + somatic SNVs, INDELs, CNV & LOH'
  - Tumor RNA
  - Targeted RNA Solid Tumor Fusion assay
  - Fusion/ITD detection
  - Tumor DNA
  - DNA based methylation array for CNS tumor classification
...
Here are the gene targets included in this assay.
...
### Will DNA methylation results be returned for all patients?
 ...
 For CNS patients only, a tumor classification by DNA methylation will have a clinical result returned to contacts indicated on the MCI Site Contact Form. For STS, RAR, NBL, and EWS patients, DNA methylation array data will be banked for research submission into the CCDI Data Ecosystem without return of results to sites.
...
### How can MCI data be accessed through the CCDI Data Ecosystem?
 ...
 In addition to clinical characterization data, CCDI leverages residual biospecimens for deeper research characterization, such as whole genome sequences (WGS), transcriptomics, proteomics, metabolomics, and other emerging technologies like spatial transcriptomics (learn more about research characterization [in this paper](https://pmc.ncbi.nlm.nih.gov/articles/PMC12360469/)).
...
Technical questions about accessing results or result availability should be directed to IGM by email at [igmmci@nationwidechildrens.org](mailto:igmmci@nationwidechildrens.org).
...
- Central nervous system group: [MCICNS@childrensoncologygroup.org](mailto:MCICNS@childrensoncologygroup.org)
 ...
 - Rare tumor group: [MCIRAR@childrensoncologygroup.org

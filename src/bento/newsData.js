...
export const newsList = [
    ...
    },
    {
        ...
        highlight: 'National Cancer Institute (NCI) has released a <a href="https://nationalcancerplan.cancer.gov/?cid=eb_govdel_allstaff_ncp" target="_blank" rel="noopener noreferrer">National Cancer Plan</a>, a long-term, ambitious framework to end cancer as we know it. The Plan represents a coordinated national response to achieve the goals of the <a href="https://www.cancer.gov/research/key-initiatives/moonshot-cancer-initiative" target="_blank" rel="noopener noreferrer">Cancer Moonshot</a> and deliver better cancer outcomes. The plan offers something for everyone who wants to join in creating a society where more cancers are prevented and every person with cancer lives a full and active life.',

export const MCIContent = [
    ...
    },
    {
        ...
        table: {
            ...
            body: ['Tumor + normal DNA', 'Enhanced ES', 'Germline + somatic SNVs, INDELs, CNV & LOH', 'Tumor RNA', 'Targeted RNA Solid Tumor Fusion assay', 'Fusion/ITD detection', 'Tumor DNA', 'Tumor DNA', 'Disease classification'],
        },
    },
    {

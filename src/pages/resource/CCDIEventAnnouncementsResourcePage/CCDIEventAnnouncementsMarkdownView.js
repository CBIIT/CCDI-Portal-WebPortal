...
import MciMarkdown from '../MCIResourcePage/MciMarkdown';
...
const CCDIEventAnnouncementsMarkdownView = ({ data }) => {
    ...
    const handleScroll = () => {
        const bodyElement = document.getElementById('CCDIEventArchiveBody');
        ...
        <CCDIContainer headerImg={data.CCDI_Event_Announcements_Header}>
            ...
            <CCDIBody id='CCDIEventArchiveBody'>
                ...
                <div className='contentSection'>
                    ...
                    {data.ccdiEventAnnouncementsIntroMarkdown && (
                        <div className='introContainer'>
                            <MciMarkdown>{data.ccdiEventAnnouncementsIntroMarkdown}</MciMarkdown>
                        </div>
                    )}
                    {!data.ccdiEventAnnouncementsIntroMarkdown && data.ccdiEventAnnouncementsIntroText && (
                        <div className='introContainer'>{ReactHtmlParser(data.ccdiEventAnnouncementsIntroText)}</div>
                    )}
                        {
...
export default CCDIEventAnnouncementsMarkdownView;

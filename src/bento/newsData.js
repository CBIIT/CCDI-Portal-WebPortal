...
export const newsList = [
    ...
    },
    {
        ...
        date: 'APRIL 5, 2023',
        slug: 'Genomics and clinical data for MCI participants is available at NCI’s Cancer Data Service and accessible through CGC.',
        highlight: '<p>De-identified molecular characterization, clinical reports, and demographic & phenotypic data from participants in the <a href="https://www.cancer.gov/research/areas/childhood/childhood-cancer-data-initiative/data-ecosystem/molecular-characterization?cid=eb_govdel" rel="noreferrer noopener" target="_blank">CCDI Molecular Characterization Initiative</a> (MCI) has been released, <a href="https://www.ncbi.nlm.nih.gov/projects/gap/cgi-bin/study.cgi?study_id=phs002790.v2.p1" rel="noreferrer noopener" target="_blank">phs00290.v2.p1</a> and could be requested through dbGaP <a href="https://www.youtube.com/watch?v=m0xp_cCO7kA" rel="noreferrer noopener" target="_blank">controlled-access process</a>. There is data associated with 1145 participants and additional data from MCI will be released each month.  The data are accessible through Cancer genomics Cloud for in secure workspaces and facilitate uploading of researchers’ own data for aggregated/federated analysis.</p>',
    ...
    },
    {
        ...
        highlight: 'NCI hosted the CCDI Symposium on March 24, 2023, which brought together hundreds of members of the childhood cancer community. The event featured presentations on CCDI Data Ecosystem progress by Drs. Anthony Kerlavage and Subhashini Jagu. <a href="https://www.cancer.gov/research/areas/childhood/childhood-cancer-data-initiative/events-webinars/symposium-0" target="_blank" rel="noopener noreferrer">View the event presentation</a> and <a href="https://videocast.nih.gov/watch=49171" target="_blank" rel="noopener noreferrer">watch the recording</a>.',

window.injectedEnv = {
    ...
    REACT_APP_GA_TRACKING_ID: '${REACT_APP_GA_TRACKING_ID}',
    REACT_APP_STATIC_CONTENT_URL: '${REACT_APP_STATIC_CONTENT_URL}',
    REACT_APP_DMN_URL: '${REACT_APP_DMN_URL}',
    REACT_APP_C3DC: '${REACT_APP_C3DC}',
    REACT_APP_C3DC_URL: '${REACT_APP_C3DC_URL}',
    REACT_APP_C3DC_BACKEND_API: '${REACT_APP_C3DC_BACKEND_API}'
};
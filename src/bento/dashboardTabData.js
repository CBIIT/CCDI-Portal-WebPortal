...
query sampleOverview(
    ...
    sampleOverview(
        ...
        diagnosis_anatomic_site: $diagnosis_anatomic_site,
        disease_phase: $disease_phase,
        sample_diagnosis_classification: $diagnosis_classification,
        sample_diagnosis_classification_system: $diagnosis_classification_system,
        sample_diagnosis_verification_status: $diagnosis_verification_status,
        sample_diagnosis_basis: $diagnosis_basis,
        sample_diagnosis_comment: $diagnosis_comment,
        vital_status: $vital_status,
        sample_anatomic_site: $sample_anatomic_site,
        participant_age_at_collection: $participant_age_at_collection,
        sample_tumor_status: $sample_tumor_status,
